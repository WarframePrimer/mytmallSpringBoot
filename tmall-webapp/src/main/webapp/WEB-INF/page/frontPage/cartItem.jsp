                ...
                <table class="cartProductItemTable">
                    ...
                    <c:forEach items="${cartItemList}" var="cartItem">
                        ...
                        <tr class="cartProductItemTR" oiid="${cartItem.id}" pid="${cartItem['product']['id']}">
                            <!--全选框和商品图片-->
                            <td width="140px">
                                <img class="productIfSelect" src="<%=request.getContextPath()%>/img/site/cartNotSelected.png" selectit="false"
                            ...
                            <td>
                                <div class="cartProductLinkOutDiv">
                                    ...
                                    <div class="cartProductLinkInnerDiv">
                                        <a href="#nowhere"><img src="<%=request.getContextPath()%>/img/site/creditcard.png" alt="图片加载失败"
                                                                title="支持信用卡支付"></a>
                                        <a href="#nowhere"><img src="<%=request.getContextPath()%>/img/site/7day.png" alt="图片加载失败"
                                                                title="消费者保障服务 卖家承诺7天退换"></a>
                                        <a href="#nowhere"><img src="<%=request.getContextPath()%>/img/site/promise.png" alt="图片加载失败"
