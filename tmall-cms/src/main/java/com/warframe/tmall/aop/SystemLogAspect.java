package com.warframe.tmall.aop;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.warframe.tmall.annotation.SystemControllerLog)")
     ...
     * Service层切点,注解方式
     */
    @Pointcut("@annotation(com.warframe.tmall.annotation.SystemServiceLog)")
