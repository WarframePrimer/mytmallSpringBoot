...
import com.warframe.tmall.domain.dto.RoleDto;
import com.warframe.tmall.domain.pojo.*;
import com.warframe.tmall.repository.TbPermissionMapper;
import com.warframe.tmall.repository.TbRoleMapper;
import com.warframe.tmall.repository.TbRolePermMapper;
import com.warframe.tmall.repository.TbUserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public TbUser getUserByUsername(String username) {
        ...
        try {
            ...
            throw new TmallException("通过ID获取用户信息失败");
        }
        if(!list.isEmpty()){
            return list.get(0);
        }
    ...
    public DataTablesResult getRoleList() {
        ...
        if(list1==null){
            throw new TmallException("获取角色列表失败");
        }
    ...
    public List<TbRole> getAllRoles() {
        ...
        if(list==null){
            throw new TmallException("获取所有角色列表失败");
        }
        return list;
    }
    ...
    public int addRole(TbRole tbRole) {
        ...
        if(getRoleByRoleName(tbRole.getName())!=null){
            throw new TmallException("该角色名已存在");
        }
        if(tbRoleMapper.insert(tbRole)!=1){
            throw new TmallException("添加角色失败");
        }
        if(tbRole.getRoles()!=null){
            ...
            for(int i=0;i<tbRole.getRoles().length;i++){
                ...
                if(tbRolePermMapper.insert(tbRolePerm)!=1){
                    throw new TmallException("添加角色-权限失败");
                }
            }
        }
        return 1;
    ...
    public TbRole getRoleByRoleName(String roleName) {
        ...
        try {
            ...
            throw new TmallException("通过角色名获取角色失败");
        }
        if(!list.isEmpty()){
            return list.get(0);
        }
    ...
    public boolean getRoleByEditName(int id,String roleName) {
        ...
        TbRole newRole=null;
        if(tbRole==null){
            throw new TmallException("通过ID获取角色失败");
        }
    ...
    public int updateRole(TbRole tbRole) {
        ...
        if(tbRoleMapper.updateByPrimaryKey(tbRole)!=1){
            throw new TmallException("更新角色失败");
        }
        if(tbRole.getRoles()!=null){
            //删除已有角色-权限
            ...
            if(list!=null) {
                for (TbRolePerm tbRolePerm : list) {
                    if (tbRolePermMapper.deleteByPrimaryKey(tbRolePerm.getId()) != 1) {
                        throw new TmallException("删除角色权限失败");
                    }
                }
            }
            //新增
            for(int i=0;i<tbRole.getRoles().length;i++){
                ...
                if(tbRolePermMapper.insert(tbRolePerm)!=1){
                    throw new TmallException("编辑角色-权限失败");
                }
            }
        }else{
            TbRolePermExample example=new TbRolePermExample();
    ...
    public int deleteRole(int id) {
        ...
        if(list==null){
            throw new TmallException("查询用户角色失败");
        }
        if(list.size()!=0){
            return 0;
        }
        if(tbRoleMapper.deleteByPrimaryKey(id)!=1){
            throw new TmallException("删除角色失败");
        }
        TbRolePermExample example=new TbRolePermExample();
        TbRolePermExample.Criteria criteria=example.createCriteria();
        ...
        if(list1==null){
            throw new TmallException("查询角色权限失败");
        }
    ...
    public DataTablesResult getPermissionList() {
        ...
        if(list==null){
            throw new TmallException("获取权限列表失败");
        }
    ...
    public int addPermission(TbPermission tbPermission) {
        ...
        if(tbPermissionMapper.insert(tbPermission)!=1){
            throw new TmallException("添加权限失败");
        }
        return 1;
    }
    ...
    public int updatePermission(TbPermission tbPermission) {
        ...
        if(tbPermissionMapper.updateByPrimaryKey(tbPermission)!=1){
            throw new TmallException("更新权限失败");
        }
        return 1;
    }
    ...
    public int deletePermission(int id) {
        ...
        if(tbPermissionMapper.deleteByPrimaryKey(id)!=1){
            throw new TmallException("删除权限失败");
        }
        TbRolePermExample example=new TbRolePermExample();
        TbRolePermExample.Criteria criteria=example.createCriteria();
    ...
    public DataTablesResult getUserList() {
        ...
        if(list==null){
            throw new TmallException("获取用户列表失败");
        }
    ...
    public int addUser(TbUser user) {
        ...
        if(!getUserByName(user.getUsername())){
            throw new TmallException("用户名已存在");
        }
        if(!getUserByPhone(user.getPhone())){
            throw new TmallException("手机号已存在");
        }
        if(!getUserByEmail(user.getEmail())){
            throw new TmallException("邮箱已存在");
        }
        ...
        if(tbUserMapper.insert(user)!=1){
            throw new TmallException("添加用户失败");
        }
        return 1;
    }
    ...
    public int updateUser(TbUser user) {
        ...
        if(tbUserMapper.updateByPrimaryKey(user)!=1){
            throw new TmallException("更新用户失败");
        }
        return 1;
    }
    ...
    public int changeUserState(Long id,int state) {
        ...
        if(tbUserMapper.updateByPrimaryKey(tbUser)!=1){
            throw new TmallException("更新用户状态失败");
        }
        return 1;
    }
    ...
    public int changePassword(TbUser tbUser) {
        ...
        if(tbUserMapper.updateByPrimaryKey(old)!=1){
            throw new TmallException("修改用户密码失败");
        }
        return 1;
    }
    ...
    public int deleteUser(Long userId) {
        ...
        if(tbUserMapper.deleteByPrimaryKey(userId)!=1){
            throw new TmallException("删除用户失败");
        }
        return 1;
    }
    ...
    public Long countUser() {
        ...
        if(result==null){
            throw new TmallException("统计用户数失败");
        }
        return result;
    }
}
